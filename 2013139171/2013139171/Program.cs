...
namespace _2013139171
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Persona persona1 = new Persona("Escalante", "Dyer", "Jose", 'J');
            Persona persona2 = new Persona("Bazalar", "Contreras", "Hector", 'M');
            Persona persona3 = new Persona("Faggiani", "Mercado", "Jeferson", 'A');
            Persona persona4 = new Persona("Altamirano", "Martell", "Alonso", 'R');
            ...
            TipoHospedaje tipoHospedaje1 = new TipoHospedaje("Hotel", 1.13);
            TipoHospedaje tipoHospedaje2 = new TipoHospedaje("Hostal", 1.09);
            TipoHospedaje tipoHospedaje3 = new TipoHospedaje("BackPacker", 1.07);
            ...
            CalificacionHospedaje calificacionHospedaje5 = new CalificacionHospedaje("5 Estrellas", 1.13);

            CategoriaHospedaje categoriaHospedaje1 = new CategoriaHospedaje("Basico", 1.05);
            CategoriaHospedaje categoriaHospedaje2 = new CategoriaHospedaje("Normal", 1.07);
            CategoriaHospedaje categoriaHospedaje3 = new CategoriaHospedaje("Vip", 1.13);

            ServicioHospedaje servicioHospedaje1 = new ServicioHospedaje("Lavandería", 1.05);
            ServicioHospedaje servicioHospedaje2 = new ServicioHospedaje("Planchado", 1.07);
            ServicioHospedaje servicioHospedaje3 = new ServicioHospedaje("Room Service", 1.13);
            ...
            TipoTransporte tipoTransporte3 = new TipoTransporte("Maritimo");

            CategoriaTransporte categoriaTransporte1 = new CategoriaTransporte("Regular");
            CategoriaTransporte categoriaTransporte2 = new CategoriaTransporte("VIP");
            ...
            CategoriaAlimentacion categoriaAlimentacion2 = new CategoriaAlimentacion("Basica");
            ...
            ComprobantePago comprobantePago1 = new ComprobantePago(tipoComprobante1, new DateTime(2017, 4, 13));
            ComprobantePago comprobantePago2 = new ComprobantePago(tipoComprobante2, new DateTime(2017, 4, 14));
            ComprobantePago comprobantePago3 = new ComprobantePago(tipoComprobante2, new DateTime(2017, 4, 15));
